...
namespace InTwo.Controls.TimeSpanPicker
{
    ...
    public partial class TimeSpanPickerPage : TimeSpanPickerBasePage
    {
        ...
        public override void InitDataSource()
        {
            ...
            var maxSeconds = Max >= TimeSpan.FromSeconds(31) ? 31 : Math.Min(Max.Seconds + stepSeconds, 31);
            TertiarySelector.DataSource = new DataSource.SecondTimeSpanDataSource(maxSeconds, stepSeconds);
